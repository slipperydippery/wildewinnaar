...
// Vue.component('Rapportgenerator', require('./components/Rapportgenerator.vue'));
Vue.component('Parallax', __webpack_require__(55));
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e327a048", Component.options)
  } else {
    hotAPI.reload("data-v-e327a048", Component.options)
' + '  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	props: ['zoomratio', 'divclass', 'divoheight', 'divowidth', 'divotop'],

	computed: {
		bgLeft: function bgLeft() {
			return -(this.bgExtraX * this.mousePercentX);
		},
		bgTop: function bgTop() {
	...
	methods: {
		...
		calculateBackground: function calculateBackground() {
...
var render = function() {
  ...
  return _c("div", { staticClass: "parallax-container" }, [
    _c(
      "div",
      {
        ...
        style: {
          ...
          transform: "translate3d(" + _vm.bgLeft + "px, " + _vm.bgTop + "px, 0)"
        }
      },
      [_vm._t("default")],
      2
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e327a048", module.exports)
  }
}
